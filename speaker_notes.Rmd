...
Before moving to the statistical analysis, I actually have a comment that I would address to my committee. Recent, outside feedback suggested adding a version of the task in English and having bilinguals complete both. Even though this suggestion make sense based on the goals of the dissertation, I haven't had enough time to fully implement it, but I intend to do so in the future; so maybe it is something that we could talk about during the questions session. 
